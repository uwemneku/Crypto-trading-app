...
export default function WhoAreWE() {
    ...
    return (
        <div ref={ref} className={`${isVisible ? "opacity-100": "opacity-0"} transition-opacity duration-500  px-6 sm:px-12 h-screen dark:bg-white flex lg:flex-row flex-col justify-center items-center`} >

            <h1 className=" block lg:hidden font-bold text-2xl text-gray-600 py-6  md:text-4xl text-center" >Who are we?</h1>
            <div className="flex flex-col lg:flex-row items-center" >
                ...
                <div className="">
                    <h1 className=" hidden lg:block font-bold text-2xl text-gray-600 py-1  lg:text-4xl text-center" >Who are we?</h1>
